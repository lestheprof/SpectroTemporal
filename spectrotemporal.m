function weightarray = spectrotemporal(sd,filelist, varargin)
...
% initialise the weights (or read them in?)
...
% calculate the onset signal for each band
% calculate the offset signal for each band
